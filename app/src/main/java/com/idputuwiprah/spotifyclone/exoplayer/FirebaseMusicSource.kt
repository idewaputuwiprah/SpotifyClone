...
import com.idputuwiprah.spotifyclone.data.remote.RemoteDatabase
import com.idputuwiprah.spotifyclone.exoplayer.State.*
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import javax.inject.Inject

class FirebaseMusicSource @Inject constructor(private val remoteDatabase: RemoteDatabase) {
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO) {
        ...
        val allSongs = remoteDatabase.getSongs()
